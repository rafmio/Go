...
import (
	...
	"minimalapi/restapi/operations"

	"github.com/go-openapi/errors"
	"github.com/go-openapi/runtime"
	"github.com/go-openapi/runtime/middleware"
	"github.com/go-swagger/go-swagger/examples/todo-list/restapi/operations/models"
)

//go:generate swagger generate server --target ../../05-minimal-swagger --name SimpleAPI --spec ../swagger.yaml --principal interface{}
...
func configureAPI(api *operations.SimpleAPIAPI) http.Handler {
	...
	// Set your custom handler for GetHello
	api.GetHelloHandler = operations.GetHelloHandlerFunc(func(params operations.GetHelloParams) middleware.Responder {
		return operations.NewGetHelloOK().WithPayload(&models.HelloResponse{
			Message: "Hello, world!",
		})
	})
