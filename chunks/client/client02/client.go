...
func main() {
  ...
  reqest.Header["Accept"] = []string{"application/json", "text/javascript", "*/*; q=0.01"}
  reqest.Header["Accept-Encoding"] = []string{"gzip", "deflate", "br"}
  reqest.Header["Accept-Language"] = []string{"en", "ru;q=0.9"}
  reqest.Header["Connection"] = []string{"keep-alive"}
  reqest.Header[""]
}
  // Request Headers:
