...
func TestFlatten(t *testing.T) {
	...
	t.Run("runs test cases", func(t *testing.T) {
		for _, strCase := range strCases {
			got := Flatten(strCase.origin)
			if !reflect.DeepEqual(got, strCase.flatted) {
				t.Errorf("got: %v, want: %v", got, strCase.flatted)
			}
		}
	})
}

// The code below has been generated by GPT, it's works:
// func TestFlatten(t *testing.T) {
// 	tests := []struct {
// 		name string
// 		list [][]string
